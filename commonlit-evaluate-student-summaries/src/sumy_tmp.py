...
# English text you want to summarize
text = """
Background 
...
# Use the LSA summarizer for English text
summarizer = LsaSummarizer()
summary = summarizer(parser.document, 10)  # Specify the number of sentences you want in the summary
